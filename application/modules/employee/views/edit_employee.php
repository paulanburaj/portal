			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/employee/update" enctype="multipart/form-data">
						  <fieldset>
...
?>
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">First Name *</label>
									<div class="controls">
											<input id="focusedInput" class="input-xlarge focused" name="fname" type="text" value="<?php  echo set_value('fname',$data[0]['fname']);?>" required>
		<?php echo form_error('fname'); ?>							</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="focusedInput">Last  Name *</label>
									<div class="controls">
											<input id="focusedInput" class="input-xlarge focused" name="lname" type="text" value="<?php  echo set_value('lname',$data[0]['lname']);?>" required><?php echo form_error('lname'); ?>
									</div>
							</div>
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">Display Name *</label>
									<div class="controls">
											<input id="focusedInput" class="input-xlarge focused" name="display_name" type="text" value="<?php  echo set_value('display_name',$data[0]['display_name']);?>" required><?php echo form_error('display_name'); ?>
									</div>
							</div>
